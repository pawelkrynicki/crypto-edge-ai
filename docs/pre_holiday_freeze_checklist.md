...
- UX2 has started with the 10B.1 information architecture shell. Full UX2 visual/product redesign remains in progress.
- 10B.1 does not change endpoints, scoring, `final_label`, `WATCHLIST` meaning, review/report logic, source rules, npm dependencies, auth, or production backend scope.
...
- Larger frontend visual redesign beyond the 10B.1 shell.
- New data sources.
