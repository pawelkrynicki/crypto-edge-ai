...
Stage: 12E.5 External Verification Links

Implemented deep links: `#candidate-results`, `#candidate-detail`, `#token-lookup`, `#external-checks`

Next implementation stage: 12E.6 Manual Verification Fallbacks
