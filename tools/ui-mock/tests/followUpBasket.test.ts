...
describe("Follow-up read-only product boundary", () => {
  ...
  it("renders three Radar layers, sub-24-hour age, lifecycle copy, and no promotion action in EN and PL", () => {
    ...
    assert.equal(formatFollowUpAge("2026-06-01T00:00:00.000Z", new Date("2026-06-01T05:30:00.000Z"), "en"), "5h");
    assert.equal(formatFollowUpAge("2026-06-01T00:00:00.000Z", new Date("2026-06-01T05:30:00.000Z"), "pl"), "5 godz.");
    assert.notEqual(formatFollowUpAge("2026-06-01T00:00:00.000Z", new Date("2026-06-01T05:30:00.000Z"), "pl"), "0 dni");
  });
