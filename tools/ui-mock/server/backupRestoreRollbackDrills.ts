...
export async function runProductRecoveryDrills(options: {
  ...
  await record(PRODUCT_RECOVERY_DRILL_SCENARIOS[0], async () => {
    ...
    for (const id of [
      ...
      "new_inbox_store", "lifecycle_audit_store", "lifecycle_cycle_receipt", "lifecycle_operation_journal", "user_workspace_sqlite", "research_evidence_sqlite", "feedback_sqlite", "ai_queue_cache_sqlite", "central_automation_state", "active_scanner_snapshot",
