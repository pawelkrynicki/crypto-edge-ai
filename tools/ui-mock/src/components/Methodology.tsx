...
const METHODOLOGY_UI_COPY = {
  pl: {
    ...
    sourcesHelp: "Radar pokazuje aktualność opublikowanej migawki i nie pobiera danych z providerów w przeglądarce.",
    ...
    statuses: "WATCHLIST i Candidate for Established",
  ...
  en: {
    ...
    sourcesHelp: "Radar shows published-snapshot freshness and does not call providers from the browser.",
