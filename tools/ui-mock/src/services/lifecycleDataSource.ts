import type { LifecycleSummary, LifecycleTokenView, SystemLifecycleStatus } from "../types/lifecycleTypes";
...
function isSummary(value: unknown): value is LifecycleSummary { return record(value) && value.schema_version === "lifecycle_summary_v1" && ["system_new_total", "system_follow_up_total", "system_main_radar_total", "follow_up_action_due", "follow_up_candidates_ready", "follow_up_displayed"].every((key) => Number.isSafeInteger(value[key])); }
